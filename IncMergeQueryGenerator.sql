drop procedure [dm].[GenerateIncMergeSQL];
CREATE PROCEDURE [dm].[GenerateIncMergeSQL] 
...
BEGIN
	...
	BEGIN TRY
		...
		USING ' + @TgtSchemaName+'.'+ 'view_inc_' + @TgtTableName + ' AS S
...
EXEC [dm].[GenerateIncMergeSQL] 'dm', 'fact_employee_mobile_sync_analysis'
